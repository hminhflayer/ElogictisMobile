...
namespace ElogictisMobile.ViewModels
{
    ...
    [DataContract]
    public class ManageItemPageViewModel : BaseViewModel
    {
        #region Fields

        private static ManageItemPageViewModel noItemPageViewModel;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ManageItemPageViewModel" /> class.
        /// </summary>
        public ManageItemPageViewModel()
        {
        }
        ...
        /// </summary>
        public static ManageItemPageViewModel BindingContext =>
            noItemPageViewModel = PopulateData<ManageItemPageViewModel>("errorAndEmpty.json");
